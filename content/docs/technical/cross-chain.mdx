...
This asynchronous settlement model decouples the merchant payment (instant, from the issuer's collateral pool) from the cardholder debit (deferred, on source chain), allowing issuers to manage credit risk and settlement timing independently.
