...
Hold stablecoins directly in your ColossusNet wallet. When you pay, the transaction amount is debited from your balance immediately. No issuer involved; your funds move directly to the merchant at **0% fees**. A tiny network fee (under one-tenth of a penny) is automatically included in the transaction; you never need to manage it manually.

### Issuer-backed (Consumer Credit / Premium Credit)
